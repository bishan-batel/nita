...
namespace GodotRx
{
  public static class SignalExtensions
  {
    ...
    public static IObservable<Control> OnGuiFocusChanged(this Viewport obj)
      => obj.ObserveSignal<Control>("gui_focus_changed");
    ...
    public static IObservable<InputEvent> OnGuiInput(this Control obj)
      => obj.ObserveSignal<InputEvent>("gui_input");
    ...
    public static IObservable<(TreeItem Item, int Column, bool Selected)> OnMultiSelected(this Tree obj)
      => obj.ObserveSignal<TreeItem, int, bool>("multi_selected");
    ...
    public static IObservable<TreeItem> OnItemCollapsed(this Tree obj)
      => obj.ObserveSignal<TreeItem>("item_collapsed");
    ...
    public static IObservable<(TreeItem Item, int Column, int Id)> OnButtonPressed(this Tree obj)
      => obj.ObserveSignal<TreeItem, int, int>("button_pressed");
    ...
    public static IObservable<Node> OnNodeSelected(this GraphEdit obj)
      => obj.ObserveSignal<Node>("node_selected");
    ...
    public static IObservable<Node> OnNodeUnselected(this GraphEdit obj)
      => obj.ObserveSignal<Node>("node_unselected");
    ...
    public static IObservable<Mesh> OnMeshUpdated(this ARVRController obj)
      => obj.ObserveSignal<Mesh>("mesh_updated");
    ...
    public static IObservable<Mesh> OnMeshUpdated(this ARVRAnchor obj)
      => obj.ObserveSignal<Mesh>("mesh_updated");
    ...
    public static IObservable<(Node Camera, InputEvent Event, Vector3 ClickPosition, Vector3 ClickNormal, int ShapeIdx)> OnInputEvent(this CollisionObject obj)
      => obj.ObserveSignal<Node, InputEvent, Vector3, Vector3, int>("input_event");

    public static IObservable<Node> OnBodyEntered(this RigidBody obj)
      => obj.ObserveSignal<Node>("body_entered");

    public static IObservable<(int BodyId, Node Body, int BodyShape, int LocalShape)> OnBodyShapeEntered(this RigidBody obj)
      => obj.ObserveSignal<int, Node, int, int>("body_shape_entered");

    public static IObservable<Unit> OnSleepingStateChanged(this RigidBody obj)
      => obj.ObserveSignal("sleeping_state_changed");

    public static IObservable<Node> OnBodyExited(this RigidBody obj)
      => obj.ObserveSignal<Node>("body_exited");

    public static IObservable<(int BodyId, Node Body, int BodyShape, int LocalShape)> OnBodyShapeExited(this RigidBody obj)
      => obj.ObserveSignal<int, Node, int, int>("body_shape_exited");

    public static IObservable<Area> OnAreaExited(this Area obj)
      => obj.ObserveSignal<Area>("area_exited");

    public static IObservable<(int AreaId, Area Area, int AreaShape, int SelfShape)> OnAreaShapeExited(this Area obj)
      => obj.ObserveSignal<int, Area, int, int>("area_shape_exited");

    public static IObservable<Node> OnBodyEntered(this Area obj)
      => obj.ObserveSignal<Node>("body_entered");

    public static IObservable<(int BodyId, Node Body, int BodyShape, int AreaShape)> OnBodyShapeEntered(this Area obj)
      => obj.ObserveSignal<int, Node, int, int>("body_shape_entered");

    public static IObservable<Area> OnAreaEntered(this Area obj)
      => obj.ObserveSignal<Area>("area_entered");

    public static IObservable<(int AreaId, Area Area, int AreaShape, int SelfShape)> OnAreaShapeEntered(this Area obj)
      => obj.ObserveSignal<int, Area, int, int>("area_shape_entered");

    public static IObservable<Node> OnBodyExited(this Area obj)
      => obj.ObserveSignal<Node>("body_exited");

    public static IObservable<(int BodyId, Node Body, int BodyShape, int AreaShape)> OnBodyShapeExited(this Area obj)
      => obj.ObserveSignal<int, Node, int, int>("body_shape_exited");
    ...
    public static IObservable<Camera> OnCameraExited(this VisibilityNotifier obj)
      => obj.ObserveSignal<Camera>("camera_exited");

    public static IObservable<Unit> OnScreenEntered(this VisibilityNotifier obj)
      => obj.ObserveSignal("screen_entered");

    public static IObservable<Camera> OnCameraEntered(this VisibilityNotifier obj)
      => obj.ObserveSignal<Camera>("camera_entered");
    ...
    public static IObservable<(int BodyId, Node Body, int BodyShape, int LocalShape)> OnBodyShapeEntered(this RigidBody2D obj)
      => obj.ObserveSignal<int, Node, int, int>("body_shape_entered");
    ...
    public static IObservable<(int BodyId, Node Body, int BodyShape, int LocalShape)> OnBodyShapeExited(this RigidBody2D obj)
      => obj.ObserveSignal<int, Node, int, int>("body_shape_exited");
    ...
    public static IObservable<(Node Viewport, InputEvent Event, int ShapeIdx)> OnInputEvent(this CollisionObject2D obj)
      => obj.ObserveSignal<Node, InputEvent, int>("input_event");

    public static IObservable<Area2D> OnAreaExited(this Area2D obj)
      => obj.ObserveSignal<Area2D>("area_exited");

    public static IObservable<(int AreaId, Area2D Area, int AreaShape, int SelfShape)> OnAreaShapeExited(this Area2D obj)
      => obj.ObserveSignal<int, Area2D, int, int>("area_shape_exited");

    public static IObservable<Node> OnBodyEntered(this Area2D obj)
      => obj.ObserveSignal<Node>("body_entered");

    public static IObservable<(int BodyId, Node Body, int BodyShape, int AreaShape)> OnBodyShapeEntered(this Area2D obj)
      => obj.ObserveSignal<int, Node, int, int>("body_shape_entered");

    public static IObservable<Area2D> OnAreaEntered(this Area2D obj)
      => obj.ObserveSignal<Area2D>("area_entered");

    public static IObservable<(int AreaId, Area2D Area, int AreaShape, int SelfShape)> OnAreaShapeEntered(this Area2D obj)
      => obj.ObserveSignal<int, Area2D, int, int>("area_shape_entered");

    public static IObservable<Node> OnBodyExited(this Area2D obj)
      => obj.ObserveSignal<Node>("body_exited");

    public static IObservable<(int BodyId, Node Body, int BodyShape, int AreaShape)> OnBodyShapeExited(this Area2D obj)
      => obj.ObserveSignal<int, Node, int, int>("body_shape_exited");

    public static IObservable<Unit> OnScreenEntered(this VisibilityNotifier2D obj)
      => obj.ObserveSignal("screen_entered");

    public static IObservable<Viewport> OnViewportEntered(this VisibilityNotifier2D obj)
      => obj.ObserveSignal<Viewport>("viewport_entered");

    public static IObservable<Unit> OnScreenExited(this VisibilityNotifier2D obj)
      => obj.ObserveSignal("screen_exited");

    public static IObservable<Viewport> OnViewportExited(this VisibilityNotifier2D obj)
      => obj.ObserveSignal<Viewport>("viewport_exited");
    ...
    public static IObservable<Node> OnNodeConfigurationWarningChanged(this SceneTree obj)
      => obj.ObserveSignal<Node>("node_configuration_warning_changed");
    ...
    public static IObservable<Node> OnNodeRemoved(this SceneTree obj)
      => obj.ObserveSignal<Node>("node_removed");

    public static IObservable<Node> OnNodeAdded(this SceneTree obj)
      => obj.ObserveSignal<Node>("node_added");
    ...
    public static IObservable<Node> OnNodeRenamed(this SceneTree obj)
      => obj.ObserveSignal<Node>("node_renamed");
    ...
    public static IObservable<Node> OnSceneChanged(this EditorPlugin obj)
      => obj.ObserveSignal<Node>("scene_changed");

    public static IObservable<Resource> OnResourceSaved(this EditorPlugin obj)
      => obj.ObserveSignal<Resource>("resource_saved");
    ...
    public static IObservable<Script> OnEditorScriptChanged(this ScriptEditor obj)
      => obj.ObserveSignal<Script>("editor_script_changed");

    public static IObservable<Script> OnScriptClose(this ScriptEditor obj)
      => obj.ObserveSignal<Script>("script_close");
    ...
    public static IObservable<(string Path, Resource Resource)> OnResourceSelected(this EditorProperty obj)
      => obj.ObserveSignal<string, Resource>("resource_selected");
    ...
    public static IObservable<Script> OnScriptCreated(this ScriptCreateDialog obj)
      => obj.ObserveSignal<Script>("script_created");
