...
namespace GodotRx.Internal
{
  ...
  {
    readonly Subject<object> _subject = new();
    ...
    void OnNext(object o1)
      => _subject.OnNext(o1);

    void OnNext(object o1, object o2)
      => _subject.OnNext((o1, o2));

    void OnNext(object o1, object o2, object o3)
      => _subject.OnNext((o1, o2, o3));

    void OnNext(object o1, object o2, object o3, object o4)
      => _subject.OnNext((o1, o2, o3, o4));

    void OnNext(object o1, object o2, object o3, object o4, object o5)
      => _subject.OnNext((o1, o2, o3, o4, o5));

    void OnNext(object o1, object o2, object o3, object o4, object o5, object o6)
  ...
  {
    protected override Unit Cast(object o) => new();
  }
